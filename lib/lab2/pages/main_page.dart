...
class _MainPageState extends State<MainPage> {
  ...
  Future<void> _checkESP32Connection() async {
    ...
    try {
      ...
      if (deviceId != null && deviceId.isNotEmpty &&
          deviceKey != null && deviceKey.isNotEmpty) {
  ...
  Future<void> _uploadCredentialsToESP32() async {
    // Ensure we have values to upload
    ...
    try {
      // First save credentials locally
      final prefs = await SharedPreferences.getInstance();
      await prefs.setString('deviceId', deviceId);
      await prefs.setString('deviceKey', deviceKey);
      ...
      // Send credentials to the device - use proper JSON format
      final command = '{"action":"setCredentials","deviceId":"$deviceId",'
          '"deviceKey":"$deviceKey"}\n';
...
// import 'package:flutter/material.dart';
// import 'package:flutter/services.dart';
// import 'package:lb5iotmob/lab2/elements/pages_list.dart';
// import 'package:lb5iotmob/lab2/logic/model/fitness_data.dart';
// import 'package:lb5iotmob/lab2/logic/service/tracker/fitness_data_service.dart';
// import 'package:lb5iotmob/lab2/widgets/custom_bottom_nav_bar.dart';
// import 'package:lb5iotmob/lab2/widgets/custom_drawer.dart';
// import 'package:mqtt_client/mqtt_client.dart';
// import 'package:mqtt_client/mqtt_server_client.dart';
// import 'package:provider/provider.dart';
// import 'package:shared_preferences/shared_preferences.dart';
